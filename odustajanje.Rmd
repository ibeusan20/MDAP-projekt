...
Analiza: ANOVA test s Chi-kvadrat statistikama procjenjuje doprinos svakog prediktora modelu. Niske p-vrijednosti ukazuju na to da uklanjanje određene varijable značajno pogoršava model, odnosno da je ta varijabla važna za predviđanje odustajanja.
...
Analiza: Točnost modela predstavlja udio ispravno klasificiranih slučajeva. Visoka točnost ukazuje na dobru prediktivnu sposobnost modela, ali treba biti oprezan kod neuravnoteženih klasa – tada je korisno dodatno analizirati metrike poput preciznosti, odziva i F1-mjere.
